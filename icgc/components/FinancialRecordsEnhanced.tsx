          ...
          {selectedMember && (
            <div className="border-t border-gray-200 pt-6">
              ...
              <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 mb-6 text-white">
                ...
                <h2 className="text-4xl mb-1"><CediIcon />{selectedMemberTotal.toFixed(2)}</h2>
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {selectedMemberTransactions.map(transaction => (
                        <tr key={transaction.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3 text-gray-900"><CediIcon />{transaction.amount.toFixed(2)}</td>
              ...
              <tbody className="divide-y divide-gray-100">
                {getFilteredTransactions().slice(0, visibleTransactions).map((transaction) => (
                  <tr key={transaction.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-gray-900"><CediIcon />{transaction.amount}</td>
